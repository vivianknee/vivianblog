...
title: Login Lesson
categories: ['Lesson']
tags: ['SASS', 'lesson', 'login']
type: hacks
week: 17
author: Vivian
description: Finn C, Theo H, Justin N
toc: True
date: 2024-1-16 12:00:00 +0000
---
...
```
    ...
    Unresolved dependencies:
       ...
       - variable personDetailsService

       - variable jwtTokenUtil

       - class ResponseCookie

       - variable ResponseCookie

       - variable HttpHeaders

       - variable ResponseEntity
